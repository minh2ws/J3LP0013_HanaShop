...
public class ManageFoodServlet extends HttpServlet {
    ...
    private final String MANAGE_PAGE = "manage-food.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("ManageFoodServlet _ SQLException: " + e.getMessage());
        } catch (NamingException e) {
            log("ManageFoodServlet _ NamingException: " + e.getMessage());
        } finally {
